...
const EditForm = (props) => {
  const [flight, setUser] = useState(props.currentFlight);
  ...
  return (
    <form className=" mt-5 container"  id="wrapper-main">
      <div className="form-group">
        <h2 className="text-primary text-warning">Edit Flight </h2>
        <input
          type="text"
          name="fligth_no "
        ...
        <span id="fligth_no" className="text-danger"></span>
        ...
        />
        <span id="return_date" className="text-danger"></span>
        <br />
        ...
        <br />
        <span id="myBtn" className="text-danger font-weight-bold"></span>
        <br />
      </div>
    </form>
  );
